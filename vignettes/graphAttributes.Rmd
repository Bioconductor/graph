...
First, we create a graph to use as an example.  We will work with a *graphAM-class* instance, however, any subclass of *graph-class* would work. See Figure [1](#fig1).
...
All edges in a graph support the same set of attributes.  The set of supported attributes can be defined and accessed using the `edgeDataDefaults` method.  
