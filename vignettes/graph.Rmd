...
author:
    ...
    W. Huber [aut],
    S. Falcon [aut],<br>
    Halimat C. Atanda [ctb] (Converted 'MultiGraphClass' and 'GraphClass' vignettes from Sweave to RMarkdown/HTML.),<br> 
    Paul Villafuerte [ctb] (Converted 'clusterGraph' vignettes from Sweave to RMarkdown/HTML.),<br>
...
<p>We briefly review some of the class structure here and refer the reader to the technical documentation for this package for more details.<br>
...
main implementations available. Which is best will depend on the particular data set and what the user wants to do with it. The only slot defined in the virtual class is **edgemode** which can be either directed or undirected indicating whether the edges are directed or not.<br>
  ...
  The class *clusterGraph* is a special form of graph for clustering. In this graph each cluster is a completely connected component (a clique) and there are no between cluster edges.<p/>
